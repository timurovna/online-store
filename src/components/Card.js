						...
						<div className="product-card-bottom">
							...
							<div>
								...
								<div className="ui modal">
									<Confirm open={this.state.showDialog} onCancel={this.toggleDialog} onConfirm={this.handleClick} />
								</div>
							</div>
							<Link to={{ pathname: '/productdetails', state: { id: this.props.product._id}}}>
...
export default connect(null, {deleteProduct: deleteProduct})(ProductCard)
