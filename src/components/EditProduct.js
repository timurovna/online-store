...
import { getDetails, updateProduct, addProduct } from '../actions/actions.js';
...
class EditProduct extends React.Component {
	...
	blurHandler = (e) => {	
		...
		if ((this.state.title!=="" && this.state.title.length<30) && this.state.image!=="" && this.state.description!=="" && this.state.category!=="none" &&
		(this.state.available!=="" && !isNaN(this.state.available)) && this.state.gender!=="none" && (this.state.rating!=="" && this.state.rating>0 && this.state.rating<6) && 
